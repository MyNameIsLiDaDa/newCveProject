...
// -------------- 作废 -------------
// groups 和 softwares 接口,
// export function groups_softwares(id) {
//   return request({
//     url: `/cyber/groups_softwares?tech_id=${ id }`,
//     method: 'get'
//   })
// }
// -----------作废-----------------
export function groups(id) {
  return request({
    url: `/cyber/groups?tech_id=${ id }`,
    method: 'get'
  })
}
export function softwares(id) {
  return request({
    url: `/cyber/softwares?tech_id=${ id }`,
    method: 'get'
  })
}
